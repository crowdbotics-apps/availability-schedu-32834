...
## Project Structure
    ...
    ├── availability_schedu_32834  # Django project configurations
...
1. Clone this repo and `cd availability_schedu_32834`
...
2. Clone this repo and `cd availability_schedu_32834`
